...
file_path <- "C:/IDS Project/PowerSC-main/Static_House_data/house_data_filtered.csv"
...
file_path <- "C:/IDS Project/PowerSC-main/Weather/weather_data.csv"
...
house_data_path <- "C:/IDS Project/PowerSC-main/Static_House_data/house_data_filtered.csv"
...
save_path <- "C:/IDS Project/PowerSC-main/Energy/energy_data.csv"
...
energy_data_path <- "C:/IDS Project/PowerSC-main/Energy/energy_data.csv"
...
write_csv(energy_data_summarized, "C:/IDS Project/PowerSC-main/Energy/energy_data_final.csv")
...
file_path <- "C:/IDS Project/PowerSC-main/Weather/weather_data_filtered.csv"
...
setwd("C:/IDS Project/PowerSC-main/Static_House_data")
...
# Read the dataset
weather_data <- read_csv("C:/IDS Project/PowerSC-main/Weather/weather_data_filtered.csv")
...
# Load datasets
house_data_path <- "C:/IDS Project/PowerSC-main/Static_House_data/house_data_filtered.csv"
weather_data_path <- "C:/IDS Project/PowerSC-main/Weather/weather_data_filtered.csv"
energy_data_path <- "C:/IDS Project/PowerSC-main/Energy/energy_data_final.csv"
...
write_csv(final_merged_data, "C:/IDS Project/PowerSC-main/Final/Merged_Dataset.csv")
...
# Read the dataset
dataset <- read_csv("C:/IDS Project/PowerSC-main/Final/Merged_Dataset.csv")
...
write_csv(dataset, "C:/IDS Project/PowerSC-main/Final/Cleaned_Merged_Dataset.csv")
...
# Load the dataset
library(readr)
data <- read_csv("C:/IDS Project/PowerSC-main/Final/Cleaned_Merged_Dataset.csv")
```
...
write_csv(test_data_increased_temp, "C:/IDS Project/PowerSC-main/Final/test_july_increased.csv")

# Print a message that the file has been saved
cat("The new weather test data for July with increased temperature has been saved at C:/IDS Project/PowerSC-main/Final/test_july_increased.csv")
...
train_data <- read_csv("C:/IDS Project/PowerSC-main/Final/Cleaned_Merged_Dataset.csv")
...
test_data <- read_csv("C:/IDS Project/PowerSC-main/Final/test_july_increased.csv")
...
train_path <- "C:/IDS Project/PowerSC-main/Final/train.csv"
test_path <- "C:/IDS Project/PowerSC-main/Final/test_july_increased.csv"
...
write_csv(combined_data, "C:/IDS Project/PowerSC-main/Final/combined_dataset.csv")

# Output to confirm the save
cat("Combined dataset saved at 'C:/IDS Project/PowerSC-main/Final/combined_dataset.csv'\n")
...
combined_data_path <- "C:/IDS Project/PowerSC-main/Final/combined_dataset.csv"
...
ggsave("C:/IDS Project/PowerSC-main/Final/energy_time_plot.png", width = 10, height = 6)
...
ui <- fluidPage(
  titlePanel("Energy Consumption Predictions for July"),
  sidebarLayout(
    sidebarPanel(
    ...
    mainPanel(
      tabsetPanel(type = "tabs",
                  tabPanel("Heating Energy", plotOutput("heatingPlot")),
                  tabPanel("Cooling Energy", plotOutput("coolingPlot"))
      )
    )
  )
)
...
server <- function(input, output) {
  # Subset data based on selected dates
  data_selected <- reactive({
    test_data_final %>%
      filter(time >= input$dateRange[1] & time <= input$dateRange[2])
  })
  
  # Create the plot for Heating Energy
  output$heatingPlot <- renderPlot({
    ggplot(data_selected(), aes(x = time)) +
      geom_line(aes(y = Heating, color = "Actual Heating")) +
      geom_line(aes(y = predicted_heating, color = "Predicted Heating"), linetype = "dashed") +
      labs(title = "Heating Energy vs Predicted",
           x = "Time", y = "Heating Energy (kWh)",
           color = "Legend") +  # Legend title
      theme_minimal() +
      scale_color_manual(values = c("Actual Heating" = "blue", "Predicted Heating" = "#779a93"))  # Manual color scale
  })
  
  # Create the plot for Cooling Energy
  output$coolingPlot <- renderPlot({
    ggplot(data_selected(), aes(x = time)) +
      geom_line(aes(y = Cooling, color = "Actual Cooling")) +
      geom_line(aes(y = predicted_cooling, color = "Predicted Cooling"), linetype = "dashed") +
      labs(title = "Cooling Energy vs Predicted",
           x = "Time", y = "Cooling Energy (kWh)",
           color = "Legend") +  # Legend title
      theme_minimal() +
      scale_color_manual(values = c("Actual Cooling" = "#0b5394", "Predicted Cooling" = "#fff073"))  # Manual color scale
  })
}
